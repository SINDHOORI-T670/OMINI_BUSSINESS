                                            ...
                                            <form method="POST" action="{{url('admin/edit/brand')}}/{{$item->id}}">
                                              ...
                                              <div class="modal-body">
                                                    ...
                                                    <fieldset class="form-group floating-label-form-group">
                                                        ...
                                                        <select class="form-control select2-multi" name="edittech[]" multiple>
                                                            <option value="0" disabled>Select any</option>
                                                            @forelse ($techs as $tech)
                                                                <option value="{{$tech->id}}"  @foreach(explode(",",$item->tech_id) as $techno) @if($techno==$tech->id) selected @else @endif @endforeach>{{$tech->name}}</option>
                                                            @empty
