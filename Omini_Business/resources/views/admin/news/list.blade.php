                                    ...
                                    <div class="modal fade text-left show" id="editResourceModal{{$item->id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel35" style="padding-right: 17px;">
                                        <div class="modal-dialog" role="document">
                                          <div class="modal-content">
                                            ...
                                            <form method="POST" action="{{url('admin/edit/subservice')}}/{{$item->id}}" enctype="multipart/form-data">
                                                @csrf
                                              <div class="modal-body">
                                                    <fieldset class="form-group floating-label-form-group">
                                                      <label for="email" class="label-control required">News Title</label>
                                                  ...
                                                  <label class="label-control required">Image</label>
                                                    ...
                                                    <span class="text-info">(Image dimension should be 1350 X 600) </span> 
                                                    @if ($errors->has('image'))
                                                          <span class="help-block">
                                                    ...
                                                    <fieldset class="form-group floating-label-form-group">
                                                        <label for="email" class="label-control">News Details</label>
                                                        <textarea cols="30" rows="15" class="form-control detail2" id="detail2{{$item->id}}" name="detail2" placeholder="Details about service">{!! strip_tags(htmlspecialchars_decode($item->News Details)) !!}</textarea>
                    ...
                    <div class="modal fade text-left show" id="createResourceModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel35" style="padding-right: 17px;">
                        <div class="modal-dialog" role="document">
                          <div class="modal-content">
                            ...
                            <form method="POST" action="{{url('admin/add/subservice')}}" enctype="multipart/form-data">
                                @csrf
                                <input type="hidden" name="main" value="{{$main}}">
                              <div class="modal-body">
                                  <fieldset class="form-group floating-label-form-group">
                                      <label for="email" class="label-control required">News Title</label>
                                      <input type="text" class="form-control" id="servicename" name="servicename" placeholder="News Title">
