  ...
  <div class="main-menu menu-fixed menu-dark menu-accordion    menu-shadow " data-scroll-to-active="true">
    <div class="main-menu-content">
      <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
        {{-- users --}}
        <li class=" nav-item">
          <a href="#"><i class="fa fa-users"></i><span class="menu-title" data-i18n="nav.page_layouts.main">Requests</span></a>
          <ul class="menu-content">
            <li><a class="menu-item" href="{{url('admin/request_list/contacts')}}" data-i18n="nav.page_layouts.1_column">Contacts</a>
            </li>
            <li><a class="menu-item" href="{{url('admin/request_list/partnerships')}}" data-i18n="nav.page_layouts.2_columns">Partnerships</a>
            </li>
          </ul>
        </li>
        ...
        <!-- masters -->
        {{-- <li class=" nav-item">
          <a href="#"><i class="icon-layers"></i><span class="menu-title" data-i18n="nav.page_layouts.main">Masters</span></a>
          <ul class="menu-content">
            <li><a class="menu-item" href="{{url('admin/list/Redington/services')}}" data-i18n="nav.page_layouts.1_column">Services</a>
            </li>
            <li><a class="menu-item" href="{{url('admin/list/Redington/technologies')}}" data-i18n="nav.page_layouts.2_columns">Technologies</a>
            </li>
            <li><a class="menu-item" href="{{url('admin/list/brands')}}" data-i18n="nav.page_layouts.2_columns">Brands</a>
            </li>
            <li><a class="menu-item" href="{{url('admin/list/regions')}}" data-i18n="nav.page_layouts.2_columns">Regions</a>
            </li>
            <li><a class="menu-item" href="{{url('admin/list/products')}}" data-i18n="nav.page_layouts.2_columns">Products</a>
            </li>
            <li><a class="menu-item" href="{{url('admin/prest_questions')}}" data-i18n="nav.page_layouts.2_columns">Preset Questions</a>
            </li>
          </ul>
        </li> --}}
        ...
        {{-- Promotions --}}
        {{-- <li class=" nav-item"><a href="{{url('admin/list/promotions')}}"><i class="icon-direction"></i><span class="menu-title" data-i18n="nav.chat-application.main">Promotions</span></a>
        </li>  --}}

        {{-- Feedback --}}
        {{-- <li class=" nav-item"><a href="{{url('admin/feedbacks')}}"><i class="ft-message-square"></i><span class="menu-title" data-i18n="nav.chat-application.main">Feedbacks</span></a>
        </li>  --}}

        {{-- Blogs --}}
        {{-- <li class=" nav-item"><a href="{{url('admin/page/settings')}}"><i class="ft-check-square"></i><span class="menu-title" data-i18n="nav.chat-application.main">Page Settings</span></a>
        </li> --}}
